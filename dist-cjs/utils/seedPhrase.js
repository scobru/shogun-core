 ...
 */
async function mnemonicToSeedAsync(mnemonic, username) {
    ...
    return (0, bip39_1.mnemonicToSeed)(mnemonic, passphrase);
}
/**
 ...
 */
async function deriveCredentialsFromMnemonic(mnemonic, username) {
