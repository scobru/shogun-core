...
async function testInteractiveDoubleRatchet() {
    try {
        ...
        const { initializeSignalUser, getSignalPublicKeyBundle, performSignalX3DHKeyExchange, } = await Promise.resolve().then(() => __importStar(require("../crypto/signal-protocol.js")));
