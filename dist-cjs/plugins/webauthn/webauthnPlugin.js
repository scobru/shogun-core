    ...
    async signUp(username, options) {
        try {
            ...
            if (seedPhrase) {
                ...
                const { password } = await (0, seedPhrase_1.deriveCredentialsFromMnemonic)(seedPhrase, username);
                ...
                try {
                    ...
                    console.warn('[webauthnPlugin] Could not create passkey, seed-only mode:', e);
                }
            }
            else {
