...
class NostrSigner {
    ...
    async createSigningCredential(address) {
        try {
            ...
            errorHandler_1.ErrorHandler.handle(errorHandler_1.ErrorType.BITCOIN, 'NOSTR_CREDENTIAL_ERROR', 'Error creating Nostr signing credential', error);
    ...
    async generatePassword(signature) {
        ...
        try {
            ...
            errorHandler_1.ErrorHandler.handle(errorHandler_1.ErrorType.ENCRYPTION, 'NOSTR_PASSWORD_ERROR', 'Error generating password', error);
    ...
    createAuthenticator(address) {
        ...
        return async (data) => {
            try {
                ...
                errorHandler_1.ErrorHandler.handle(errorHandler_1.ErrorType.AUTHENTICATION, 'NOSTR_AUTH_ERROR', 'Nostr authentication error', error);
                throw error;
            }
        };
    }
    ...
    async createDerivedKeyPair(address, extra) {
        ...
        try {
            ...
            errorHandler_1.ErrorHandler.handle(errorHandler_1.ErrorType.ENCRYPTION, 'NOSTR_KEY_DERIVATION_ERROR', 'Error deriving keys from Nostr credential', error);
            throw error;
        }
    }
    /**
    ...
    async createGunUser(address, gunInstance) {
        ...
        try {
            ...
            return new Promise((resolve) => {
                const handleAuth = (authAck) => {
                    if (authAck.err) {
                        errorHandler_1.ErrorHandler.handle(errorHandler_1.ErrorType.AUTHENTICATION, 'NOSTR_GUN_AUTH_FAILED', 'NostrSigner - GunDB auth failed', authAck.err);
            ...
            errorHandler_1.ErrorHandler.handle(errorHandler_1.ErrorType.DATABASE, 'NOSTR_CREATE_USER_ERROR', 'Error creating Gun user', error);
    ...
    async signWithDerivedKeys(data, address, extra) {
        try {
            ...
            errorHandler_1.ErrorHandler.handle(errorHandler_1.ErrorType.SIGNATURE, 'NOSTR_DERIVED_SIGN_ERROR', 'Error signing with derived keys', error);
            throw error;
        }
    }
    /**
