...
export interface CryptoMethods {
    ...
    initializeDoubleRatchet: (sharedSecret: ArrayBuffer, isInitiator: boolean, remotePublicKey?: CryptoKey | null, x3dhEphemeralPublic?: ArrayBuffer) => Promise<DoubleRatchetState>;
