 ...
 */
export declare function mnemonicToSeedAsync(mnemonic: string, username: string): Promise<Uint8Array>;
/**
 ...
 */
export declare function deriveCredentialsFromMnemonic(mnemonic: string, username: string): Promise<{
    password: string;
    seed: Uint8Array;
}>;
/**
