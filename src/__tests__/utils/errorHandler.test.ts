import { ErrorHandler, createError, ErrorType, ShogunError } from '../../utils/errorHandler';
...
describe('ErrorHandler', () => {
  ...
  describe('ErrorHandler.getRecentErrors', () => {
    it('should return recent errors', () => {
      const error1 = createError(ErrorType.AUTHENTICATION, 'AUTH_001', 'Error 1');
  ...
  describe('ErrorHandler.getErrorStats', () => {
    it('should return error statistics', () => {
      const error1 = createError(ErrorType.AUTHENTICATION, 'AUTH_001', 'Error 1');
      const error2 = createError(ErrorType.AUTHENTICATION, 'AUTH_002', 'Error 2');
  ...
  describe('ErrorHandler.debug', () => {
    it('should log debug messages', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith(
        expect.stringContaining('[AuthenticationError] AUTH_001: Debug message')
      );
