...
import derive, { DeriveOptions } from "../../holster/derive";
...
describe("Derive Module", () => {
  ...
  describe("Basic functionality", () => {
    it("should derive keys with default options (P-256 only)", async () => {
      ...
      const result = await derive(sea, password, extra);
    ...
    it("should derive keys with custom options", async () => {
      ...
      const result = await derive(sea, password, extra, options);
  ...
  describe("Input handling", () => {
    ...
    it("should handle null/undefined password (uses random)", async () => {
      ...
      const result = await derive(sea, null, extra);
    ...
    it("should handle null/undefined extra", async () => {
      ...
      const result = await derive(sea, password, null);
  ...
  describe("Error handling", () => {
    it("should throw error for insufficient input entropy", async () => {
      ...
      await expect(derive(sea, password, extra)).rejects.toThrow(
    ...
    it("should handle invalid secp256k1 private key for Bitcoin", async () => {
      ...
      await expect(derive(sea, password, extra, options)).rejects.toThrow(
  ...
  describe("Consistency", () => {
    it("should generate consistent results for same input", async () => {
      ...
      const result1 = await derive(sea, password, extra);
      const result2 = await derive(sea, password, extra);
    ...
    it("should generate different results for different inputs", async () => {
      ...
      const result1 = await derive(sea, password1, extra, {
        includeP256: false,
        includeSecp256k1Bitcoin: true,
      });
      const result2 = await derive(sea, password2, extra, {
        includeP256: false,
        includeSecp256k1Bitcoin: true,
      });
