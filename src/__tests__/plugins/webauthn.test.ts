...
describe('WebAuthn Plugin', () => {
  ...
  afterAll(() => {
    Object.defineProperty(navigator, 'credentials', { value: originalCredentials });
  });
  ...
  test('dovrebbe verificare se WebAuthn è supportato', () => {
    ...
    Object.defineProperty(navigator, 'credentials', { value: undefined });
  ...
  test('dovrebbe gestire i timeout in modo appropriato', async () => {
    ...
    try {
      ...
      navigator.credentials.create = jest.fn().mockImplementation(() => new Promise(() => {}));
