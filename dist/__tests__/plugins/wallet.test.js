    ...
    return {
        ...
        Mnemonic: {
            fromEntropy: jest.fn().mockReturnValue({
                phrase: "test one two three four five six seven eight nine ten eleven twelve",
            }),
        },
...
describe("WalletManager", () => {
    ...
    beforeEach(() => {
        ...
        if (global.Gun && global.Gun.SEA) {
            ...
            global.Gun.SEA.decrypt = jest
                .fn()
                .mockResolvedValue("test one two three four five six seven eight nine ten eleven twelve");
        }
        ...
        walletManager.generateNewMnemonic = jest
            .fn()
            .mockReturnValue("test one two three four five six seven eight nine ten eleven twelve");
    });
    ...
    test("dovrebbe generare un nuovo mnemonic valido", () => {
        ...
        walletManager.generateNewMnemonic = jest
            .fn()
            .mockReturnValue("one two three four five six seven eight nine ten eleven twelve");
