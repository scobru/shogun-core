 ...
 */
export function generatePairFromSeed(seed) {
    return __awaiter(this, void 0, void 0, function () {
        var sea, pair, err_1, derivedPassword, pair, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4: return [4 /*yield*/, sea.work(seed, 'shogun-seed-salt', // Constant salt for consistent derivation
                    null, { name: 'SHA-256' })];
                case 5:
                    derivedPassword = _b.sent();
                    _b.label = 6;
                case 6:
                    _b.trys.push([6, 8, , 9]);
                    return [4 /*yield*/, sea.pair(null, { seed: derivedPassword })];
                case 7:
                    pair = _b.sent();
                    if (pair && pair.pub && pair.priv) {
                        return [2 /*return*/, pair];
                ...
                case 8:
                    _a = _b.sent();
                    return [3 /*break*/, 9];
                case 9: throw new Error('Deterministic key generation not supported by this Gun version');
            }
        });
    });
}
 ...
 * @returns Promise resolving to a SEA key pair
 */
export function generatePairFromMnemonic(mnemonic, username) {
    return __awaiter(this, void 0, void 0, function () {
        var seedContext;
        return __generator(this, function (_a) {
            ...
            seedContext = "".concat(mnemonic.trim(), ":").concat(username.trim());
            return [2 /*return*/, generatePairFromSeed(seedContext)];
        });
    });
}
