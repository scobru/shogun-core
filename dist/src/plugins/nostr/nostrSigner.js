        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_1 = _a.sent();
                        ErrorHandler.handle(ErrorType.BITCOIN, 'NOSTR_CREDENTIAL_ERROR', 'Error creating Nostr signing credential', error_1);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                try {
                    ...
                    ErrorHandler.handle(ErrorType.ENCRYPTION, 'NOSTR_PASSWORD_ERROR', 'Error generating password', error);
        ...
        return function (data) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_2 = _a.sent();
                        ErrorHandler.handle(ErrorType.AUTHENTICATION, 'NOSTR_AUTH_ERROR', 'Nostr authentication error', error_2);
                        throw error_2;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_3 = _a.sent();
                        ErrorHandler.handle(ErrorType.ENCRYPTION, 'NOSTR_KEY_DERIVATION_ERROR', 'Error deriving keys from Nostr credential', error_3);
                        throw error_3;
                    case 4: return [2 /*return*/];
                }
            });
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, new Promise(function (resolve) {
                                var handleAuth = function (authAck) {
                                    if (authAck.err) {
                                        ErrorHandler.handle(ErrorType.AUTHENTICATION, 'NOSTR_GUN_AUTH_FAILED', 'NostrSigner - GunDB auth failed', authAck.err);
                                ...
                                gunInstance.user().create(derivedPair_1, function (ack) {
                                    if (ack.err) {
                                        ...
                                        gunInstance.user().auth(derivedPair_1, handleAuth);
                                    }
                                    else {
                    ...
                    case 3:
                        error_4 = _a.sent();
                        ErrorHandler.handle(ErrorType.DATABASE, 'NOSTR_CREATE_USER_ERROR', 'Error creating Gun user', error_4);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        error_5 = _a.sent();
                        ErrorHandler.handle(ErrorType.SIGNATURE, 'NOSTR_DERIVED_SIGN_ERROR', 'Error signing with derived keys', error_5);
                        throw error_5;
