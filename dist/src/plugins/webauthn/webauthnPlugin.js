            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        pair = void 0;
                        if (!seedPhrase) return [3 /*break*/, 7];
                        return [4 /*yield*/, deriveCredentialsFromMnemonic(seedPhrase, username)];
                    case 1:
                    ...
                    case 7: return [4 /*yield*/, this.generateCredentials(username, null, false)];
                    case 8:
                        credentials = _a.sent();
                        if (!(credentials === null || credentials === void 0 ? void 0 : credentials.success)) {
                            throw new Error((credentials === null || credentials === void 0 ? void 0 : credentials.error) || 'Unable to generate WebAuthn credentials');
                        }
                        return [4 /*yield*/, this.assertWebauthn().authenticateUser(username, credentials.credentialId, {
