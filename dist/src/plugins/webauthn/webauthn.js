...
var Webauthn = /** @class */ (function (_super) {
    ...
    Webauthn.prototype.sign = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var dataString, dataBytes, hash, challenge, options, signature;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        dataString = JSON.stringify(data);
                        dataBytes = ethers.toUtf8Bytes(dataString);
                        hash = ethers.sha256(dataBytes);
                        challenge = ethers.getBytes(hash);
                        options = {
                            challenge: challenge,
                            rpId: this.config.rpId,
                            userVerification: this.config.userVerification,
...
export function deriveWebauthnKeys(username_1, credentialIdOrSeedPhrase_1) {
    return __awaiter(this, arguments, void 0, function (username, credentialIdOrSeedPhrase, useSeedPhrase) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    if (!useSeedPhrase) return [3 /*break*/, 3];
                    return [4 /*yield*/, deriveCredentialsFromMnemonic(credentialIdOrSeedPhrase, username)];
                case 1:
                    _a = _b.sent(), password = _a.password, seed = _a.seed;
