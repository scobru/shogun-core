...
var Web3Connector = /** @class */ (function (_super) {
    ...
    Web3Connector.prototype.initProvider = function () {
        if (typeof window !== 'undefined') {
            try {
                ...
                var ethereumProvider = Web3Connector.getAvailableEthereumProvider();
                if (ethereumProvider) {
     ...
     */
    Web3Connector.getAvailableEthereumProvider = function () {
        var e_1, _a;
        if (typeof window === 'undefined')
            return undefined;
    ...
    Web3Connector.prototype.setupProvider = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                try {
                    if (typeof window !== 'undefined') {
                        ethereumProvider = Web3Connector.getAvailableEthereumProvider();
                        if (ethereumProvider) {
                            this.provider = new ethers.BrowserProvider(ethereumProvider);
                        }
                        else {
    ...
    Web3Connector.cachedEthereumProvider = undefined;
