...
var Web3Signer = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_1 = _a.sent();
                        ErrorHandler.handle(ErrorType.WALLET, 'WEB3_CREDENTIAL_ERROR', 'Error creating Web3 signing credential', error_1);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        error_2 = _a.sent();
                        ErrorHandler.handle(ErrorType.WALLET, 'WEB3_SIGNATURE_ERROR', 'Failed to request signature', error_2);
                        throw error_2;
        ...
        return function (data) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        error_3 = _a.sent();
                        ErrorHandler.handle(ErrorType.AUTHENTICATION, 'WEB3_AUTH_ERROR', 'Web3 authentication error', error_3);
                        throw error_3;
                    case 5: return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, new Promise(function (resolve) {
                                ...
                                gunInstance.user().auth(derivedPair_1, function (authAck) {
                                    if (authAck.err) {
                                        ErrorHandler.handle(ErrorType.AUTHENTICATION, 'WEB3_GUN_AUTH_FAILED', 'Web3Signer - GunDB auth failed', authAck.err);
                    ...
                    case 2:
                        error_4 = _a.sent();
                        ErrorHandler.handle(ErrorType.AUTHENTICATION, 'WEB3_AUTH_EXISTING_FAILED', 'Error authenticating with deterministic pair', error_4);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_5 = _a.sent();
                        ErrorHandler.handle(ErrorType.ENCRYPTION, 'WEB3_KEY_DERIVATION_ERROR', 'Error creating derived key pair from address', error_5);
                        throw error_5;
                    case 3: return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, new Promise(function (resolve) {
                                ...
                                gunInstance.user().create(derivedPair_2, function (ack) {
                                    if (ack.err) {
                                        ErrorHandler.handle(ErrorType.DATABASE, 'WEB3_USER_CREATION_FAILED', 'Web3Signer - user creation failed, trying auth', ack.err);
                                        // Try to login if user already exists
                                        gunInstance.user().auth(derivedPair_2, function (authAck) {
                                            if (authAck.err) {
                                                ErrorHandler.handle(ErrorType.AUTHENTICATION, 'WEB3_USER_AUTH_FAILED', 'Web3Signer - auth also failed', authAck.err);
                                                resolve({ success: false, error: authAck.err });
                                            }
                                            else {
                                                var userPub = authAck.pub;
                                        ...
                                        gunInstance.user().auth(derivedPair_2, function (authAck) {
                                            if (authAck.err) {
                                                ErrorHandler.handle(ErrorType.AUTHENTICATION, 'WEB3_LOGIN_AFTER_CREATION_FAILED', 'Web3Signer - login after creation failed', authAck.err);
                                                resolve({ success: false, error: authAck.err });
                                            }
                                            else {
                                                var userPub = authAck.pub;
                    ...
                    case 2:
                        error_6 = _a.sent();
                        ErrorHandler.handle(ErrorType.DATABASE, 'WEB3_CREATE_USER_ERROR', 'Error creating Gun user', error_6);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        error_7 = _a.sent();
                        ErrorHandler.handle(ErrorType.SIGNATURE, 'WEB3_DERIVED_SIGN_ERROR', 'Error signing with derived keys', error_7);
                        throw error_7;
                    case 5: return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_8 = _a.sent();
                        ErrorHandler.handle(ErrorType.ENCRYPTION, 'WEB3_GET_PUB_ERROR', 'Error getting Gun user pub', error_8);
    ...
    Web3Signer.prototype.getPassword = function (address) {
        try {
            ...
            ErrorHandler.handle(ErrorType.ENCRYPTION, 'WEB3_GET_PASSWORD_ERROR', 'Error getting password', error);
            return undefined;
        }
    };
    /**
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_9 = _a.sent();
                        ErrorHandler.handle(ErrorType.ENCRYPTION, 'WEB3_CONSISTENCY_ERROR', 'Error verifying consistency', error_9);
