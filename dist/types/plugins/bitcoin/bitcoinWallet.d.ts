...
import { ConnectionResult, BitcoinCredentials, AlbyProvider, NostrProvider, BitcoinWalletConfig, BitcoinKeyPair } from "./types";
declare global {
    interface Window {
        alby?: AlbyProvider;
        nostr?: NostrProvider;
 ...
 */
export declare class BitcoinWallet extends EventEmitter {
     ...
     */
    setKeyPair(keyPair: BitcoinKeyPair): void;
    /**
