...
exports.ShogunCore = exports.ShogunEventEmitter = exports.ShogunStorage = exports.Gun = exports.SEA = exports.RelayVerifier = void 0;
...
class ShogunCore {
    ...
    constructor(config) {
        ...
        try {
            ...
            (0, logger_1.log)("GunInstance initialized successfully");
        }
        catch (error) {
