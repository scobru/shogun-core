...
class Webauthn {
    ...
    async authenticateUser(username, salt) {
        try {
            ...
            if (!salt) {
                errorHandler_1.ErrorHandler.handle(errorHandler_1.ErrorType.WEBAUTHN, "NO_CREDENTIALS", "No WebAuthn credentials found for this username", null);
                return {
                    success: false,
            ...
            try {
                ...
                if (!assertion) {
                    errorHandler_1.ErrorHandler.handle(errorHandler_1.ErrorType.WEBAUTHN, "VERIFICATION_FAILED", "WebAuthn verification failed", null);
            ...
            errorHandler_1.ErrorHandler.handle(errorHandler_1.ErrorType.WEBAUTHN, "AUTH_ERROR", error instanceof Error ? error.message : "Unknown WebAuthn error", error);
            return {
                success: false,
